            ...
            <div class="container mx-auto px-6 py-4">
                    ...
                    <div class="hidden md:flex items-center gap-6">
                        <?php if(auth()->guard()->guest()): ?>
                            ...
                            <?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700">Register</a>
                            <?php endif; ?>
                        <?php else: ?>
                            <div class="relative">
                ...
                <div id="mobileMenu" class="hidden md:hidden mt-4 space-y-4">
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="block w-full text-center bg-blue-600 text-white py-2 rounded-lg">Register</a>
                    <?php else: ?>
