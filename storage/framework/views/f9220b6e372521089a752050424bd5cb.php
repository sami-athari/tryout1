        ...
        <nav class="bg-white border-b sticky top-0 z-50">
            <div class="container mx-auto px-6 py-4">
                <div class="flex justify-between items-center">
                    <a href="<?php echo e(url('/')); ?>" class="text-2xl font-bold text-gray-900">Seilmu</a>

                    <!-- Desktop Menu -->
                    <div class="hidden lg:flex items-center gap-6">
                        <?php if(auth()->guard()->check()): ?>
                            <?php if($isUser): ?>
                                <a href="<?php echo e(route('user.dashboard')); ?>" class="text-gray-700 hover:text-gray-900">Home</a>
                                <a href="<?php echo e(route('user.about')); ?>" class="text-gray-700 hover:text-gray-900">About</a>
                                <a href="<?php echo e(route('user.cart')); ?>" class="text-gray-700 hover:text-gray-900">Cart</a>
                                <a href="<?php echo e(route('user.transactions')); ?>" class="text-gray-700 hover:text-gray-900">Orders</a>
                            <?php endif; ?>
                        <?php endif; ?>
                        ...
                        <div class="relative group">
                            <a href="<?php echo e(route('chat.index')); ?>" class="text-gray-700 hover:text-gray-900 flex items-center gap-1">
                                ...
                                <?php if($userNotifCount > 0): ?>
                                    <span class="bg-red-500 text-white text-xs w-5 h-5 rounded-full flex items-center justify-center"><?php echo e($userNotifCount); ?></span>
                                <?php endif; ?>
                            </a>
                                    ...
                                    <?php else: ?>
                                        <ul class="max-h-80 overflow-y-auto">
                                            <?php $__currentLoopData = $userNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li><a href="<?php echo e(route('chat.show', $notif->sender_id)); ?>" class="flex items-start p-4 hover:bg-gray-50">
                                                    ...
                                                    <div class="ml-3 flex-1">
                                                        ...
                                                        <p class="text-sm text-gray-600"><?php echo e(\Illuminate\Support\Str::limit($notif->message ?? 'New message', 100)); ?></p>
                                                        <p class="text-xs text-gray-400"><?php echo e($notif->created_at->diffForHumans()); ?></p>
                                                    </div>
                                                </a></li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                        <div class="p-3 border-t text-center"><a href="<?php echo e(route('chat.index')); ?>" class="text-blue-600 text-sm">View all</a></div>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <!-- Search & Filter -->
                    <form method="GET" action="<?php echo e(route('user.dashboard')); ?>" class="hidden lg:flex items-center gap-4">
                        <div class="relative">
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search..." class="ajax-search border rounded-lg px-4 py-2 w-64" autocomplete="off" data-suggest-url="<?php echo e(route('api.products.suggest')); ?>">
                        ...
                        <div class="relative">
                            ...
                            <div id="priceSortPanel" class="hidden absolute right-0 mt-2 w-72 bg-white border rounded-lg shadow-lg p-4">
                                <div class="mb-4">
                                    ...
                                    <label class="block"><input type="radio" name="sort" value="latest" <?php echo e(request('sort')=='latest'?'checked':''); ?>> Newest</label>
                                    <label class="block"><input type="radio" name="sort" value="best" <?php echo e(request('sort')=='best'?'checked':''); ?>> Best Seller</label>
                                    <label class="block"><input type="radio" name="sort_harga" value="asc" <?php echo e(request('sort_harga')=='asc'?'checked':''); ?>> Lowest Price</label>
                                    <label class="block"><input type="radio" name="sort_harga" value="desc" <?php echo e(request('sort_harga')=='desc'?'checked':''); ?>> Highest Price</label>
                                </div>
                                <div class="mb-4">
                                    <div class="text-sm font-semibold mb-2">Price Range</div>
                                    <div class="flex gap-2">
                                        <input type="number" name="price_min" value="<?php echo e(request('price_min')); ?>" placeholder="Min" class="w-1/2 border rounded px-2 py-1">
                                        <input type="number" name="price_max" value="<?php echo e(request('price_max')); ?>" placeholder="Max" class="w-1/2 border rounded px-2 py-1">
                                    </div>
                                </div>
                    ...
                    <div class="hidden lg:flex items-center gap-4">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <a href="<?php echo e(route('login')); ?>" class="text-gray-700">Login</a>
                            <a href="<?php echo e(route('register')); ?>" class="bg-blue-600 text-white px-6 py-2 rounded-lg">Sign Up</a>
                        <?php else: ?>
                            <div class="relative">
                                ...
                                <div id="dropdownMenu" class="hidden absolute right-0 mt-2 w-64 bg-white border rounded-lg shadow-lg">
                                    ...
                                    <a href="<?php echo e(route('user.wishlist')); ?>" class="block px-4 py-3 hover:bg-gray-50">Wishlist</a>
                ...
                <div id="mobileMenu" class="hidden lg:hidden mt-4 space-y-4">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('user.dashboard')); ?>" class="block py-2">Home</a>
                        <a href="<?php echo e(route('user.about')); ?>" class="block py-2">About</a>
                        <a href="<?php echo e(route('user.cart')); ?>" class="block py-2">Cart</a>
                        <a href="<?php echo e(route('user.transactions')); ?>" class="block py-2">Orders</a>
                        <a href="<?php echo e(route('chat.index')); ?>" class="block py-2">Chat <?php if($userNotifCount > 0): ?><span class="bg-red-500 text-white text-xs px-2 py-0.5 rounded-full"><?php echo e($userNotifCount); ?></span><?php endif; ?></a>
                    <?php endif; ?>

                    <input type="text" name="search" placeholder="Search..." class="ajax-search w-full border rounded-lg px-4 py-2" data-suggest-url="<?php echo e(route('api.products.suggest')); ?>">
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('login')); ?>" class="block w-full text-center border py-2 rounded-lg">Login</a>
                        <a href="<?php echo e(route('register')); ?>" class="block w-full text-center bg-blue-600 text-white py-2 rounded-lg">Sign Up</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('user.wishlist')); ?>" class="block py-2">Wishlist</a>
