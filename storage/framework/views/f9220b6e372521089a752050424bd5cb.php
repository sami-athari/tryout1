                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="hidden lg:flex items-center gap-8">
                        <?php if(auth()->guard()->check()): ?>
                            <?php if($isUser): ?>
                                <a href="<?php echo e(route('user.dashboard')); ?>" class="text-gray-700 hover:text-blue-600 transition-colors font-medium">Home</a>
                                <a href="<?php echo e(route('user.about')); ?>" class="text-gray-700 hover:text-blue-600 transition-colors font-medium">About</a>
                                <a href="<?php echo e(route('user.cart')); ?>" class="text-gray-700 hover:text-blue-600 transition-colors font-medium">Cart</a>
                                <a href="<?php echo e(route('user.transactions')); ?>" class="text-gray-700 hover:text-blue-600 transition-colors font-medium">Orders</a>
                            <?php endif; ?>
                        <?php endif; ?>

                        <!-- Chat with notifications -->
                        <div class="relative group">
                            <a href="<?php echo e(route('chat.index')); ?>" class="flex items-center gap-2 text-gray-700 hover:text-blue-600 transition-colors font-medium">
                                    ...
                                    <?php else: ?>
                                        <ul class="max-h-80 overflow-y-auto">
                                            <?php $__currentLoopData = $userNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li>
                                                    <a href="<?php echo e(route('chat.show', $notif->sender_id)); ?>" class="flex items-start p-4 hover:bg-gray-50 transition-colors">
                                                        ...
                                                        <div class="ml-3 flex-1">
                                                            <div class="flex justify-between items-start">
                                                                <p class="font-semibold text-gray-900"><?php echo e($notif->sender->name ?? 'User'); ?></p>
                                                                <p class="text-xs text-gray-500"><?php echo e($notif->created_at->diffForHumans()); ?></p>
                                                            </div>
                                                            <p class="text-sm text-gray-600 mt-1"><?php echo e(\Illuminate\Support\Str::limit($notif->message ?? 'New message', 100)); ?></p>
                                                        </div>
                                                    </a>
                                                </li>
                                        ...
                                        <div class="p-3 border-t text-center">
                                            <a href="<?php echo e(route('chat.index')); ?>" class="text-blue-600 hover:text-blue-700 font-medium text-sm">View all messages</a>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                       ...
                       <div class="hidden lg:flex items-center gap-8">
        <form method="GET" action="<?php echo e(route('user.dashboard')); ?>" class="hidden lg:flex items-center gap-8">
           ...
           <button type="button" id="priceSortBtn"
            ...
            <div id="priceSortPanel" class="hidden absolute right-0 mt-2 w-72 bg-white border rounded-xl shadow-xl p-4">
                ...
                <div class="mb-4">
                    ...
                    <label><input type="radio" name="sort" value="latest" <?php echo e(request('sort')=='latest'?'checked':''); ?>> Newest</label><br>
                    <label><input type="radio" name="sort" value="best" <?php echo e(request('sort')=='best'?'checked':''); ?>> Best Seller</label><br>
                    <label><input type="radio" name="sort_harga" value="asc" <?php echo e(request('sort_harga')=='asc'?'checked':''); ?>> Lowest</label><br>
                    <label><input type="radio" name="sort_harga" value="desc" <?php echo e(request('sort_harga')=='desc'?'checked':''); ?>> Highest</label>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="flex gap-2">
                        <input type="number" name="price_min" value="<?php echo e(request('price_min')); ?>" placeholder="Min" class="w-1/2 border rounded-lg px-3 py-2">
                        <input type="number" name="price_max" value="<?php echo e(request('price_max')); ?>" placeholder="Max" class="w-1/2 border rounded-lg px-3 py-2">
                    </div>
                </div>
            ...
            Apply
                    ...
                    <div class="hidden lg:flex items-center gap-4">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <a href="<?php echo e(route('login')); ?>" class="px-6 py-2 text-gray-700 hover:text-blue-600 font-medium transition-colors">Login</a>
                            <a href="<?php echo e(route('register')); ?>" class="btn-primary bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-2 rounded-xl font-medium hover:shadow-lg transition-all transform hover:scale-105">
                                Sign Up
                            </a>
                        <?php else: ?>
                            <div class="relative">
                                ...
                                <div id="dropdownMenu" class="hidden absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-2xl border overflow-hidden dropdown-enter">
                                    ...
                                    <a href="<?php echo e(route('user.wishlist')); ?>" class="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 transition-colors">
                ...
                <div id="mobileMenu" class="mobile-menu lg:hidden">
                    <div class="pt-4 pb-6 space-y-4">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('user.dashboard')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors">Home</a>
                            <a href="<?php echo e(route('user.about')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors">About</a>
                            <a href="<?php echo e(route('user.cart')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors">Cart</a>
                            <a href="<?php echo e(route('user.transactions')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors">Orders</a>
                            <a href="<?php echo e(route('chat.index')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors">
                                Chat
                                <?php if($userNotifCount > 0): ?>
                                    <span class="inline-block bg-red-500 text-white text-xs px-2 py-0.5 rounded-full ml-2"><?php echo e($userNotifCount); ?></span>
                                <?php endif; ?>
                            </a>
                        <?php endif; ?>
                                    ...
                                    <div>
                                        ...
                                        <div class="flex gap-3">
                                            <label class="flex items-center cursor-pointer">
                                                <input type="radio" name="sort_harga" value="asc" class="form-radio text-blue-600" <?php echo e(request('sort_harga') == 'asc' ? 'checked' : ''); ?>>
                                                <span class="ml-2 text-gray-800">Lowest</span>
                                            </label>
                                            <label class="flex items-center cursor-pointer">
                                                <input type="radio" name="sort_harga" value="desc" class="form-radio text-blue-600" <?php echo e(request('sort_harga') == 'desc' ? 'checked' : ''); ?>>
                                                <span class="ml-2 text-gray-800">Highest</span>

                                            </label>
                                            <label class="flex items-center cursor-pointer">
        <input type="radio" name="sort" value="best" class="form-radio text-blue-600"
               <?php echo e(request('sort') == 'best' ? 'checked' : ''); ?>>
        <span class="ml-2 text-gray-800">Best Seller</span>
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <div class="space-y-2 pt-4 border-t">
                                <a href="<?php echo e(route('login')); ?>" class="block w-full text-center px-6 py-2 border border-blue-600 text-blue-600 rounded-xl font-medium hover:bg-blue-50 transition-all">Login</a>
                                <a href="<?php echo e(route('register')); ?>" class="block w-full text-center bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-2 rounded-xl font-medium hover:shadow-lg transition-all">Sign Up</a>
                            </div>
                        <?php else: ?>
                            <div class="pt-4 border-t space-y-2">
                                <a href="<?php echo e(route('user.wishlist')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors">
                                    ❤️ Wishlist
                                </a>
